	...
	<section class="content">
		...
		<div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- Horizontal Form -->
                        <form class="form-horizontal" action="{{ route('EducationStore') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-footer clearfix">
                                    <button type="submit" class="btn btn-info float-right"><i class="fas fa-plus"></i> Add Education</button>
                                </div>
                            </div>
                        </form>
                    <!-- /.card -->
