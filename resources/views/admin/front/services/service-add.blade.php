...
@section('content')
	...
	<section class="content">
		...
		<div class="container-fluid">
            ...
            <form class="form-horizontal" action="{{ route('ServiceAddStore') }}" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">{{ __('Services Add') }}</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="inputName" placeholder="Service Title">
                                    @error('title')
                ...
                <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" id="icon" placeholder="fa fa-icon">
                                @error('icon')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <div class="input-group my-colorpicker1 colorpicker-element" data-colorpicker-id="2">
                                    <input type="text" name="icon_color" class="form-control @error('icon_color') is-invalid @enderror" data-original-title="" title="" id="inputName" value="#000000">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <div class="input-group my-colorpicker2 colorpicker-element" data-colorpicker-id="2">
                                    <input type="text" name="icon_hover_color" class="form-control @error('icon_hover_color') is-invalid @enderror" data-original-title="" title="" value="#fff">
                                    <div class="input-group-append">
                                    <span class="input-group-text"><i class="fas fa-square" style="color: #fff"></i></span>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <div class="input-group my-colorpicker3 colorpicker-element" data-colorpicker-id="2">
                                    <input type="text" name="bg_color" class="form-control @error('bg_color') is-invalid @enderror" data-original-title="" title="" value="#F4F6F9">
                                    <div class="input-group-append">
                                    <span class="input-group-text"><i class="fas fa-square" style="color: #F4F6F9"></i></span>
                                    </div>
                                </div>
                            @error('bg_color')
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <div class="input-group my-colorpicker4 colorpicker-element" data-colorpicker-id="2">
                                    <input type="text" name="bg_hover_color" class="form-control @error('bg_hover_color') is-invalid @enderror" data-original-title="" title="" value="#ff5828">
                                    <div class="input-group-append">
                                    <span class="input-group-text"><i class="fas fa-square" style="color: #ff5828"></i></span>
                                    </div>
                                </div>
                        ...
                        <button type="submit" class="btn btn-primary float-right"><i class="far fa-share-square"></i> Add Service</button>
                        </div>
                    </div>
                    </div>
                    <!-- /.card -->
